...
-- Creează tabelele lipsă și completează configurația

-- Creează tabelul invoices
...
-- Verifică și completează permisiunile dacă lipsesc
...
-- Șterge și recreează mapările de permisiuni
DELETE FROM role_permissions;

-- Atribuie permisiuni pentru CLIENT
...
-- Atribuie toate permisiunile pentru EMPLOYEE
INSERT INTO role_permissions (role_id, permission_id) 
SELECT r.id, p.id 
FROM roles r, permissions p 
WHERE r.name = 'employee';

-- Atribuie toate permisiunile pentru ADMIN
INSERT INTO role_permissions (role_id, permission_id) 
SELECT r.id, p.id 
FROM roles r, permissions p 
WHERE r.name = 'admin';
